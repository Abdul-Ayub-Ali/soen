        ...
        <div className="rounded-[2rem] border border-white/10 bg-slate-900/90 p-8 shadow-[0_25px_100px_-40px_rgba(14,165,233,0.5)] backdrop-blur-xl sm:p-12">
          <div className="mb-10 text-center">
            ...
            <h1 className="mt-4 text-4xl font-semibold leading-tight text-white sm:text-5xl">
              Secure Chats. Shared Rooms. AI Assistance.
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-slate-400">
              Log in and join your collaboration room, or create a new workspace
              with instant AI support.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className="rounded-[1.75rem] border border-slate-700 bg-slate-950/70 p-8">
              ...
              <p className="mt-4 text-slate-400">
                Create your Seon account, then create rooms, invite
                collaborators, and chat with AI in real time.
              </p>
              <Link
                to="/register"
              ...
              <div className="mt-10 space-y-4 rounded-3xl bg-slate-900/90 p-5 text-sm text-slate-400">
                <p className="font-medium text-slate-200">Tip for AI chat</p>
                <p>
                  Add <span className="text-cyan-300">@ai</span> to any message
                  and the assistant will answer directly in the room.
                </p>
              </div>
            </div>
          </div>
